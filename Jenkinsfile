pipeline {
    ...
    stages {
        ...
        stage('Create Launch Template Version') {
            steps {
                ...
                aws ec2 create-launch-template-version \
                    ...
                    --source-version 1 \
                    --version-description 'Version 4 with updated AMI' \
        ...
        stage('Modify Launch Template') {
            steps {
                script {
                    sh 'aws ec2 modify-launch-template --launch-template-name C360-TEMPLATE --default-version 4'
                }
            }
        }
        ...
        stage('Update Auto Scaling Group') {
            steps {
                script {
                    sh 'aws autoscaling update-auto-scaling-group --auto-scaling-group-name c360-asg --launch-template "LaunchTemplateName=C360-TEMPLATE,Version=4"'
                }
            }
        }
